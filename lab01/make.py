...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file s01e02.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=avr/arduino/uno --templates=/root/trampoline/goil/templates/ s01e02.oil")
	sys.exit(1)
...
oilCompiler = "goil"
oilFlags = ["-t=avr/arduino/uno", "--templates=/root/trampoline/goil/templates/"]
...
#--- Add generated files
sourceList.append("s01e02/tpl_app_config.c")

sourceList.append("s01e02/tpl_dispatch_table.c")
sourceList.append("s01e02/tpl_invoque.S")
sourceList.append("s01e02/tpl_interrupts.c")

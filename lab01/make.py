...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Make file for application s01e01_cpu
...
sys.path.append("/path/to/your/trampoline/make")
...
try:
	...
	print("goil -t=posix/linux --templates=~/trampoline/goil/templates/ s01e01.oil")
	sys.exit(1)
...
oilCompiler = "goil"
oilFlags = ["-t=posix/linux", "--templates=~/trampoline/goil/templates/"]
trampoline_base_path = "/path/to/your/trampoline/"

...
includeDirs += ["-I","/root/trampoline/machines/avr/arduino/cores/arduino"]
includeDirs += ["-I","/root/trampoline/machines/avr/arduino/"]
includeDirs += ["-I","/root/trampoline/machines/avr/arduino/variants/standard"]
includeDirs += ["-I","/root/trampoline/machines/avr"]
if with_ioc:
...
#--- OIL file
oilSourceList.append("s01e02.oil")
...
cSourceList.append(projfile.ProjectFile("s01e02.cpp"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("s01e02/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("s01e02/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("s01e02/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("s01e02/tpl_interrupts.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary s01e02_exe.hex from s01e02_exe")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("s01e02_exe")
  postCommand.mCommand.append("s01e02_exe.hex")
...
postVariableMapping = dict(
  ...
  ARCH_PATH='/root/trampoline/machines/avr',
  BOARD_PATH='/root/trampoline/machines/avr/arduino/uno',
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing s01e02_exe on avr/arduino/uno\033[0m")

...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Build file for application s01e01_cpu
...
includeDirs += ["-I", os.path.normpath(os.path.join(trampoline_base_path, "machines/posix"))]
includeDirs += ["-I", os.path.normpath(os.path.join(trampoline_base_path, "machines/posix"))]
includeDirs += ["-I", os.path.normpath(os.path.join(trampoline_base_path, "machines/../viper"))]
if with_ioc:
  includeDirs += ["-I", os.path.normpath(os.path.join(trampoline_base_path, "ioc"))]
includeDirs += ["-I", os.path.normpath(os.path.join(trampoline_base_path, "com"))]
includeDirs += ["-I", os.path.normpath(os.path.join(trampoline_base_path, "os"))]
includeDirs += ["-I", os.path.normpath(os.path.join(trampoline_base_path, "debug"))]

 ...
 *
 * OS data structure generated from application s01e01_cpu
...
CONST(tpl_appmode_mask, OS_CONST) tpl_alarm_app_mode[ALARM_COUNT] = {
  1 /* alarm AlarmStop : stdAppmode */ ,
  1 /* alarm AlarmTaskA : stdAppmode */ ,
  1 /* alarm AlarmTaskB : stdAppmode */ 
};
...
/* Task StopTask identifier */
#define StopTask_id 2
CONST(TaskType, AUTOMATIC) StopTask = StopTask_id;

/*=============================================================================
 * Declaration of Alarm IDs
 */

/* Alarm AlarmStop identifier */
#define AlarmStop_id 0
CONST(AlarmType, AUTOMATIC) AlarmStop = AlarmStop_id;

/* Alarm AlarmTaskA identifier */
#define AlarmTaskA_id 1
CONST(AlarmType, AUTOMATIC) AlarmTaskA = AlarmTaskA_id;

/* Alarm AlarmTaskB identifier */
#define AlarmTaskB_id 2
CONST(AlarmType, AUTOMATIC) AlarmTaskB = AlarmTaskB_id;
...
/*-----------------------------------------------------------------------------
 * Task StopTask descriptor
 */
#define APP_Task_StopTask_START_SEC_CODE

#include "tpl_memmap.h"
/*
 * Task StopTask function prototype
 */

FUNC(void, OS_APPL_CODE) StopTask_function(void);
#define APP_Task_StopTask_STOP_SEC_CODE
 ...
 * Task StopTask stack
 */
#define APP_Task_StopTask_START_SEC_STACK
#include "tpl_memmap.h"
tpl_stack_word StopTask_stack_zone[32768/sizeof(tpl_stack_word)];
#define APP_Task_StopTask_STOP_SEC_STACK
#include "tpl_memmap.h"

#define OS_START_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"
struct TPL_STACK StopTask_stack = {StopTask_stack_zone, 32768};
#define OS_STOP_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"

#define StopTask_STACK &StopTask_stack

/*
 * Task StopTask context
 */
#define OS_START_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"
struct TPL_CONTEXT StopTask_context;
#define OS_STOP_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"

#define StopTask_CONTEXT &StopTask_context
...
/*
 * Static descriptor of task StopTask
 */
CONST(tpl_proc_static, OS_CONST) StopTask_task_stat_desc = {
  /* context                  */  StopTask_CONTEXT,
  /* stack                    */  StopTask_STACK,
  /* entry point (function)   */  StopTask_function,
  /* internal ressource       */  NULL,
  /* task id                  */  StopTask_id,
#if WITH_OSAPPLICATION == YES
  /* OS application id        */  
...
#include "tpl_memmap.h"
/*
 * Dynamic descriptor of task StopTask
 */
VAR(tpl_proc, OS_VAR) StopTask_task_desc = {
  /* resources                      */  NULL,
#if WITH_OSAPPLICATION == YES
  /* if > 0 the process is trusted  */  0,    
#endif /* WITH_OSAPPLICATION */
 ...
 */
/*-----------------------------------------------------------------------------
 * Alarm AlarmStop descriptor
 *
 * This alarm does the activation of task StopTask
 */
...
CONST(tpl_task_activation_action, OS_CONST) AlarmStop_action = {
  {
...
CONST(tpl_alarm_static, OS_CONST) AlarmStop_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , AlarmStop_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&AlarmStop_action
};
...
VAR(tpl_time_obj, OS_VAR) AlarmStop_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&AlarmStop_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  0,
    /* date                         */  6000,
...
CONST(tpl_task_activation_action, OS_CONST) AlarmTaskA_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  TaskA_id
...
CONST(tpl_alarm_static, OS_CONST) AlarmTaskA_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , AlarmTaskA_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&AlarmTaskA_action
};
...
VAR(tpl_time_obj, OS_VAR) AlarmTaskA_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&AlarmTaskA_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  500,
    /* date                         */  0,
...
CONST(tpl_task_activation_action, OS_CONST) AlarmTaskB_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  TaskB_id
...
CONST(tpl_alarm_static, OS_CONST) AlarmTaskB_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_ID == YES)
    /* id of the alarm for tracing  */  , AlarmTaskB_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&AlarmTaskB_action
};
...
VAR(tpl_time_obj, OS_VAR) AlarmTaskB_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&AlarmTaskB_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  750,
    /* date                         */  1500,
...
CONSTP2VAR(tpl_time_obj, AUTOMATIC, OS_APPL_DATA)
  ...
  &AlarmStop_alarm_desc,
  &AlarmTaskA_alarm_desc,
  &AlarmTaskB_alarm_desc
};
#define OS_STOP_SEC_CONST_UNSPECIFIED
#include "tpl_memmap.h"
